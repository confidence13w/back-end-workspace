...
public class A_Match {
	...
	public void method2() {
		...
		boolean result2 = students.stream() // 이렇게 하면 애매해짐
		        .allMatch(student -> student.getAge() >= 20 && student.getGender().equals("남자"));
		  System.out.println("나이가 20살 이상인 학생들이 모두 남자인지? " + result2);
		...
		boolean result3 = students.stream()
		    ...
		    System.out.println("평균이 70점 이상인 남학생이 한 명 이상 존재하는가? " + result3);
	}
