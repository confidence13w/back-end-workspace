...
/*
    ...
    * 자료형 
	...
	3. 날짜 및 시간 
		- DATE : 날짜 저장하는데 사용 
        - TIME : 시간 저장하는데 사용 
        - DATETIME / TIMESPAMP : 날짜와 시간을 함께 저장 
	4. 불리언 
		- BOOLEAN / BOOL : 참(True) 또는 거짓(False) 값을 지정하는데 사용 
	5. 이진 자료형 
		- BLOB : 이진 데이터를 저장하는데 사용. 이미지나 동영상과 같은 이진 파일 
        --> 실제로는 이미니자 동영상은 따로 관리함 (URL만 문자형으로 저장하는 편)
*/
...
INSERT INTO member VALUES(2, 'user02', 'pass02', '공재욱', '남', NULL,
						  NULL, NOW());
INSERT INTO member VALUES(2, 'user02', 'pass02', '공재욱', '남', NULL,
						  NULL, current_date());
...
INSERT INTO mem_notnull VALUES(1, 'user01', 'pass01', '채승훈', '남', null,
						  null, null); 
INSERT INTO mem_notnull VALUES(2, 'user02', null, '손정배', '남', null,
						  null, current_date()); 
-- >> NOT NULL 제약조건에 위배되어 오류 발생!
INSERT INTO mem_notnull VALUES(2, 'user01', 'pass01', '손정배', '남', null,
						  null, current_date()); 
...
-- >> 회원번호(mem_no)가 동일해도 insert 되는 게 문제!
...
/*
    ...
    1. ON DELETE RESTRICTED (기본값)
		: 자식데이터로 쓰이는 부모데이터는 삭제가 아예 안 되게끔 
...
CREATE TABLE employee_copy
SELECT emp_id, emp_name, salary, salary*12 FROM kh.employee WHERE 1 = 0;
